...
async function main() {
    try {
        ...
        textOverlay3 = setupText(canvas, "toon levels: " + toonLevel)
        setupText(canvas, "press a/r to change/reset arcball mode", 3);
        setupText(canvas, "press 1 - 5 to change to shading level", 4);
