...
const cameraHeightBase = 5.0;
const cameraHeightMagnitude = 5.0
...
function render() {
    ...
    let camY = cameraHeightBase + Math.sin(glMatrix.toRadian(cameraHeightSpeed * elapsedTime)) * cameraHeightMagnitude
